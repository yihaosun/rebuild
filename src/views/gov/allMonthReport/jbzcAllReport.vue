  ...
  <div>
    <div class='content_show'>
      <div class="choose_wrap">
        <span class="date_title">报表时间（基本支出）：</span>
        <el-date-picker
          v-model="date"
          size="medium"
          type="month"
   ...
   'color':' #fff',
    ...
    'text-align': 'center'
        ...
        >
          <el-table-column prop="GOV_OUTLAY_CODE" label="功能科目编码" width="150" fixed></el-table-column>
          <el-table-column prop="GOV_OUTLAY_NAME" label="功能科目名称" width="150" fixed></el-table-column>
...
<script>
import { lookJbzcByYthList } from "@/api/gov/allMonthReport";
import { lookJbzcByYyList } from "@/api/gov/allMonthReport";
import { downJbzcByYthList } from "@/api/gov/allMonthReport";
import { downJbzcByYyList } from "@/api/gov/allMonthReport";
