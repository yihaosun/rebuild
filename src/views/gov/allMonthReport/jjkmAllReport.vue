  ...
  <div>
   ...
   'color':' #fff',
    ...
    'text-align': 'center'
        ...
        >
          <el-table-column prop="OUTLAY_CODE" label="功能科目编码" width="150" fixed></el-table-column>
          <el-table-column prop="OUTLAY_NAME" label="功能科目名称" width="150" fixed></el-table-column>
...
<script>
import { lookJjkmByYthList } from "@/api/gov/allMonthReport";
import { lookJjkmByYyList } from "@/api/gov/allMonthReport";
import { downJjkmByYthList } from "@/api/gov/allMonthReport";
import { downJjkmByYyList } from "@/api/gov/allMonthReport";
