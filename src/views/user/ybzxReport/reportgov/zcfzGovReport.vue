...
<script>
import { getZcfzGovList } from "@/api/town/reportgov";
import { downZcfzGovList } from "@/api/town/reportgov";
export default {
  data() {
    return {
      loading: false,
       ...
       CPOSTGUID: this.cpostguid,
        ...
        .then(response => {
          ...
          downloadElement.href = href;
                  downloadElement.download = `${this.shortname+this.year+"年"+this.month+"月"}资产负债表月报.xls`; //下载后文件名
